...
export const campaigns: CampaignData[] = [
  { id: 'cam1', name: 'Summer Sale 2025', source: 'Facebook', spend: 5000, revenue: 15000, roas: 3, clicks: 1200, launchDate: '2025-05-01', breakEvenDays: 5 },
  ...
  { id: 'cam4', name: 'Holiday Special', source: 'Instagram', spend: 12000, revenue: 40000, roas: 3.33, clicks: 3000, launchDate: '2025-05-15', breakEvenDays: 3 },
...
export const dailyRoas: DailyRoasData[] = Array.from({ length: 30 }, (_, i) => {
    ...
    return {
        ...
        Facebook: Number((Math.random() * 2 + 1.5).toFixed(2)),
        Instagram: Number((Math.random() * 1.8 + 1.2).toFixed(2)),
